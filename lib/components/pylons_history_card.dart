    ...
    return Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ListTile(
          ...
          title: RichText(
              text: TextSpan(text: "Linda", style: const TextStyle(color: Colors.black, fontWeight: FontWeight.w500, fontSize: 14), children: [
            TextSpan(
              text: " ${'purchased'.tr()} ",
              style: const TextStyle(color: kTextColor, fontWeight: FontWeight.w400, fontSize: 16),
            ),
            const TextSpan(text: "'Title of Artwork'", style: TextStyle(color: kTextColor, fontWeight: FontWeight.w500, fontSize: 16))
          ])),
