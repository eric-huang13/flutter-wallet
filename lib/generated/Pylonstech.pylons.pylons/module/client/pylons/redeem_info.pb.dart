...
class RedeemInfo extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  RedeemInfo copyWith(void Function(RedeemInfo) updates) => super.copyWith((message) => updates(message as RedeemInfo)); // ignore: deprecated_member_use
...
class CreatePaymentAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreatePaymentAccount', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
  ...
  factory CreatePaymentAccount() => create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreatePaymentAccount copyWith(void Function(CreatePaymentAccount) updates) => super.copyWith((message) => updates(message as CreatePaymentAccount)); // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
