...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ..pc<$6.Cookbook>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cookbookList', $pb.PbFieldType.PM, protoName: 'cookbookList', subBuilder: $6.Cookbook.create)
    ...
    ..pc<$9.Execution>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pendingExecutionList', $pb.PbFieldType.PM, protoName: 'pendingExecutionList', subBuilder: $9.Execution.create)
    ...
    ..pc<$9.Execution>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionList', $pb.PbFieldType.PM, protoName: 'executionList', subBuilder: $9.Execution.create)
    ..pc<$10.GoogleInAppPurchaseOrder>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'googleInAppPurchaseOrderList', $pb.PbFieldType.PM, protoName: 'googleInAppPurchaseOrderList', subBuilder: $10.GoogleInAppPurchaseOrder.create)
    ...
    ..pc<$8.Trade>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tradeList', $pb.PbFieldType.PM, protoName: 'tradeList', subBuilder: $8.Trade.create)
    ..pc<$12.UserMap>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountList', $pb.PbFieldType.PM, protoName: 'accountList', subBuilder: $12.UserMap.create)
    ..pc<$7.PaymentInfo>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentInfoList', $pb.PbFieldType.PM, protoName: 'paymentInfoList', subBuilder: $7.PaymentInfo.create)
    ..pc<$5.RedeemInfo>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'redeemInfoList', $pb.PbFieldType.PM, protoName: 'redeemInfoList', subBuilder: $5.RedeemInfo.create)
