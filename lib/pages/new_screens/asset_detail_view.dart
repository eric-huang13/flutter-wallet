...
class _AssetDetailViewScreenState extends State<AssetDetailViewScreen> {
  ...
  Future copyClipboard(String msg) async {
    ...
    if (widget.nftItem.type == NftType.TYPE_TRADE) {
      msg = sprintf(Constants.kUnilinkPurchaseTrade, [Constants.kUnilinkUrl, widget.nftItem.tradeID]);
    } else if (widget.nftItem.type == NftType.TYPE_ITEM) {
      msg = sprintf(Constants.kUnilinkPurchaseNftView, [Constants.kUnilinkUrl, widget.nftItem.cookbookID, widget.nftItem.itemID]);
    }
  ...
  Future onCreateTrade(String amount, String denom) async {
    ...
    final json = {
      ...
      "itemOutputs": [
        {"cookbookID": widget.nftItem.cookbookID, "itemID": widget.nftItem.itemID}
      ]
    };
                        ...
                        children: [
                          ...
                          RichText(
                            text: TextSpan(
                                ...
                                children: [TextSpan(text: widget.nftItem.creator, style: const TextStyle(color: Constants.kBlue))]),
                          ),
                            ...
                            children: [
                              ...
                              RichText(
                                text: TextSpan(
                                    ...
                                    children: [TextSpan(text: owner, style: const TextStyle(color: Constants.kBlue))]),
                              ),
                            ],
                          ),
                          const VerticalSpace(20),
                                      ...
                                      child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(sprintf("current_price".tr(), [widget.nftItem.price.toString().UvalToVal(), widget.nftItem.denom.UdenomToDenom()])),
                                              Text(sprintf("size_x".tr(), [widget.nftItem.width, widget.nftItem.height])),
                                              const SizedBox(
                                                height: 20,
                                              ),
                                              if (widget.nftItem.type == NftType.TYPE_TRADE) Text("item_on_trade".tr()),
                                            ],
                                          )),
                                    ),
                                    Text("details".tr())
...
class _PayByCardWidget extends StatefulWidget {
  const _PayByCardWidget({Key? key, required this.onPayCallback}) : super(key: key);
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: Theme.of(context).textTheme.subtitle1!.copyWith(color: Constants.kUnselectedIcon, fontSize: 16),
                  ),
                ),
                TextButton.icon(
