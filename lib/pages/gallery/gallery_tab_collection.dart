        ...
        child: Column(
          children: [
            InkWell(
                child: Row(
                  children: [
                    CachedNetworkImage(imageUrl: kImage, width: tileWidth * 2, height: tileWidth * 2 + 2, fit: BoxFit.cover),
                    const HorizontalSpace(2),
                    Column(children: [
                      CachedNetworkImage(imageUrl: kImage2, width: tileWidth, height: tileWidth, fit: BoxFit.cover),
                      const VerticalSpace(2),
                      CachedNetworkImage(imageUrl: kImage3, width: tileWidth, height: tileWidth, fit: BoxFit.cover),
                    ])
                  ],
                ),
                onTap: () {
